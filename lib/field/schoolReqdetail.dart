...
class RequestSchoolDetailScreen extends StatefulWidget {
  final String requestId;
  final id;

  const RequestSchoolDetailScreen(
      {super.key, required this.requestId, required this.id});

  @override
  State<RequestSchoolDetailScreen> createState() =>
      _RequestSchoolDetailScreenState();
}

class _RequestSchoolDetailScreenState extends State<RequestSchoolDetailScreen> {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                _detailCard(
                                    title: "School",
                                    value: partyDetail!['schoolName'] ?? ""),
                                _detailCard(
                                    title: "Grade",
                                    value: partyDetail!['gradeName'] ?? ""),
                                _detailCard(
                                    title: "Medium",
                                    value: partyDetail!['mediumName'] ?? ""),
                                _detailCard(
                                    title: "Board",
                                    value: partyDetail!['boardName'] ?? ""),
                                _detailCard(
                                    title: "Strength",
                                    value: partyDetail!['strength'] ?? ""),
                                _detailCard(
                                ...
                                // _detailCard(title: "Cluster", value: partyDetail!['cluster_name']?.toString() ?? ""),
                                _detailCard(
                                    title: "District",
