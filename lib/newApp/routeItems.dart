...
//   bool untagMode = false;
//   List<String> selectedItemsForUntag = [];
...
//   }
//
//   proceedToUntag() async {
//     if (selectedItemsForUntag.isEmpty) return;
//
//     setState(() {
//       isLoading = true;
//     });
...
//     try {
//       final response = await ApiService.post(
//         endpoint: '/routePlan/updateUnTaggedUserByItems',
//         body: {
//           "routeId": widget.id,
//           "taggedId": userData['id'],
//           "items": selectedItemsForUntag,
//         },
//       );
//
//       if (response != null && response['status'] == false) {
...
//           alreadytagged = false;
//           untagMode = false;
//           selectedItemsForUntag.clear();
//           fetchRouteitems(); // refresh list
//         });
//       }
//     } catch (e) {
//       DialogUtils.showCommonPopup(
...
//           body: {"routeId": widget.id, "taggedId": userData['id'],"ids":selectedItemsForUntag});
//
//       if (response != null && response['status'] == false) {
//         setState(() {
//           alreadytagged=false;
...
//                                       leading: untagMode
//                                           ? Checkbox(
//                                         value: selectedItemsForUntag.contains(item['partyId'].toString()),
//                                         onChanged: (value) {
//                                           setState(() {
//                                             if (value == true) {
//                                               selectedItemsForUntag.add(item['partyId'].toString());
//                                             } else {
//                                               selectedItemsForUntag.remove(item['partyId'].toString());
//                                             }
//                                           });
//                                         },
//                                       )
...
//                                           "${item['schoolName']} ${item['schoolCategoryName'] == null ? "" : "(${item['schoolCategoryName']})"}"),
//
//                                       subtitle: Text("${item['partyType'] == 0 ? 'Distributor' : 'School'}-${item['partyId']}"),
//
//                                       trailing: Column(
//                                         children: [
...
//                         ),
//                         onPressed: selectedItemsForUntag.isEmpty
//                             ? null
//                             : () {
//                           proceedToUntag();
//                         },
//                         icon: const Icon(Icons.check_circle, color: Colors.white),
//                         label: const Text('Proceed to Untag',
//                             style: TextStyle(color: Colors.white)),
//                       ),
//                     ),
//
//                   if (userData['role'] != null && alreadytagged && !untagMode)
//                     Padding(
...
//                         label:
//                         const Text('Untag Me', style: TextStyle(color: Colors.white)),
//                       ),
//                     ),
